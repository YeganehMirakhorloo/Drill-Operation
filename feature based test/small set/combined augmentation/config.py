...
class Config:
    # ANN Model Parameters - REDUCED for small dataset
    ROP_HIDDEN_NEURONS = 8  # Reduced from 23
    TORQUE_HIDDEN_NEURONS = 8  # Reduced from 27
    ACTIVATION_FUNCTION = 'relu'  # Changed from tanh
    LEARNING_RATE = 0.0005  # Reduced from 0.001
    MAX_EPOCHS = 500
    BATCH_SIZE = 4  # Reduced from 32 for small dataset
